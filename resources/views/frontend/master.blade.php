...
<head>
        ...
        <title>eKagoz - Blog, News & Magazine HTML5 Template</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-9">
                            <div class="header-banner text-right d-none d-lg-block">
                                <a href="index.html"><img src="assets/img/banner/banner-01.jpg" alt="" /></a>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="row">
                                ...
                                <div class="main-menu f-left">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li class="static"><a href="lifestyle.html">Hành trình khởi nghiệp</a>
                                                                                            </li>
                                            <li><a href="technology.html">Xu hướng</a>
                                            </li>
                                            <li><a href="sports.html">ý tưởng mới</a> </li>
                                            <li><a href="#">góc chuyên gia</a>
                                            ...
                                            <li><a href="contact.html">starup</a></li>
                                            <li><a href="contact.html">mentor</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            ...
                            {{-- <div class="col-xl-4 col-lg-2 d-none d-lg-block">
                                <div class="header-right">
                                    ...
                                    <div class="header-02-info f-right d-none d-xl-block">
                        ...
                        <div class="col-xl-2 col-lg-4 col-md-4">
                            <div class="footer-wrapper mb-30">
                                ...
                                <ul class="footer-info">
                                    ...
                                    <li><span><i class="far fa-envelope-open"></i> support@gmail.com</span></li>
                                ...
                                <ul class="footer-info-link">
                                    <li>
                                        ...
                                        <div class="footer-content">
                                            <p><a href="#">"News@</a> accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium "</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-info-icon f-left mr-20 ">
                                        ...
                                        <div class="footer-content">
                                            <p><a href="#">"24News@</a> On the other hand, we denounce with rindi natioand dislike men who are so beguiled and demoralized "</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
