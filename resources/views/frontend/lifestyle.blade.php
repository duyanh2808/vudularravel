...
@section('content')
        ...
        <main>
            ...
            <div class="breadcrumb-area pt-30 hero-padding">
                <div class="container">
                    <div class="breadcrumb-bg  pt-115 pb-115" style="background-image:url(assets/img/bg/bg-02.jpg)">
                        <div class="row">
                            <div class="col-xl-12">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8">
                            <div class="row">
                                <div class="col-xl-5 col-lg-6 mb-30">
                                    <div class="lifestyle-img">
                                        <a href="#"><img src="assets/img/news/54.jpg" alt=""></a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-6 mb-30">
                                    <div class="lifestyle-img">
                                        <a href="#"><img src="assets/img/news/55.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-6 mb-30">
                                    <div class="lifestyle-text lifestyle-04-text">
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-6 mb-30">
                                    <div class="lifestyle-img">
                                        <a href="#"><img src="assets/img/news/56.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-6 mb-30">
                                    <div class="lifestyle-text lifestyle-04-text">
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-6 mb-30">
                                    <div class="lifestyle-img">
                                        <a href="#"><img src="assets/img/news/57.jpg" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-6 mb-30">
                                    <div class="lifestyle-text lifestyle-04-text">
